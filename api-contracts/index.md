...
| Withdrawal  | `api-contract-withdrawal.md`  | Withdrawal methods (saved payout accounts) CRUD, withdrawal request lifecycle (create/list/view/edit/cancel), `WithdrawalStatus`/`WithdrawalMethodType` enums, fund reservation on create |
